...
<body class="page-loading">
  ...
  <script src="public/js/helpers/modernizr.js"></script>
  ...
  <script src="public/vendor/perfect-scrollbar/js/perfect-scrollbar.jquery.js"></script>
  <script src="public/js/helpers/smartresize.js"></script>
  ...
  <script src="public/vendor/flot-spline/js/jquery.flot.spline.js"></script>
  <script src="public/vendor/flot.orderbars/js/jquery.flot.orderBars.js"></script>
  <!-- end page scripts -->
  <!-- initialize page scripts -->
  <script src="public/js/helpers/sameheight.js"></script>
  <script src="public/js/ui/dashboard.js"></script>
